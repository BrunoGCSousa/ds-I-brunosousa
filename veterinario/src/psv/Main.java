...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(porte, javax.swing.GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE)
                            .addComponent(id))
                        .addGap(113, 113, 113)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        tblConsulta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Idade", "Raça", "Porte", "Nasc", "Vacinado", "Responsável", "Telefone", "CPF", "Endereço", "Bairro", "Número", "Sintomas"
            }
        ) {
    ...
    private void tblConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblConsultaMouseClicked
        ...
        String sId = (String)tblConsulta.getValueAt(linha, 0);
        String sNome = (String)tblConsulta.getValueAt(linha, 1);
        String sIdade = (String)tblConsulta.getValueAt(linha, 2);
        String sRaca = (String)tblConsulta.getValueAt(linha, 3);
        String sPorte = (String)tblConsulta.getValueAt(linha, 4);
        String sNasc = (String)tblConsulta.getValueAt(linha, 5);
        String sVacinado = (String)tblConsulta.getValueAt(linha, 6);
        String sResponsavel = (String)tblConsulta.getValueAt(linha, 7);
        String sTelefone = (String)tblConsulta.getValueAt(linha, 8);
        String sCpf = (String)tblConsulta.getValueAt(linha, 9);
        String sEndereco = (String)tblConsulta.getValueAt(linha, 10);
        String sBairro = (String)tblConsulta.getValueAt(linha, 11);
        String sNumero = (String)tblConsulta.getValueAt(linha, 12);
        String sSintomas = (String)tblConsulta.getValueAt(linha, 13);
        
        id.setText(sId);
        nome.setText(sNome);
        idade.setText(sIdade);
        raca.setText(sRaca);
        porte.setText(sPorte);
        nasc.setText(sNasc);
        vacinado.setText(sVacinado);
        responsavel.setText(sResponsavel);
        telefone.setText(sTelefone);
        cpf.setText(sCpf);
        endereco.setText(sEndereco);
        bairro.setText(sBairro);
        numero.setText(sNumero);
        sintomas.setText(sSintomas);
    ...
    private void btnExcluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnExcluirMouseClicked
        ...
        int i = JOptionPane.showOptionDialog(null, "Deseja excluir o pet desse id: " +id.getText()+ "?", "Exclusão", JOptionPane.YES_NO_OPTION,  JOptionPane.QUESTION_MESSAGE, null, opcoes, opcoes[0]);
